...
'''#####-----Build File-----#####'''
buildfile = 'https://raw.githubusercontent.com/nzkaize/nzkaize.github.io/main/kaize/_builds/builds.json'

'''#####-----Notifications File-----#####'''
notify_url  = 'https://gitlab.com/ifitsnotyoursdontuseit/ifitsnotyoursdontuseit/raw/main/notify.txt'

'''#####-----Excludes-----#####'''
excludes  = [addon_id, 'packages', 'Addons33.db', 'kodi.log', 'script.module.certifi', 'script.module.chardet', 'script.module.idna', 'script.module.requests', 'script.module.urllib3', 'backups', 'repository.kaize']